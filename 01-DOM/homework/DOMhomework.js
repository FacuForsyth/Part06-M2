...
function buildToDo(todo, index) {
  ...
  toDoText.innerHTML = todo.description; // utilizando el objeto todo pasado como argumento
  toDoText.id = index;
...
function buildToDos(toDos) {
  // Tu código acá:
  let array = toDos.map(function(t, i){
    return buildToDo(t, i);
  });
  return array;
}
...
function addToDo() {
  ...
  input.value = ""; //Esto se realiza para que en la vista se borre lo que se encontraba escrito
  displayToDos();
}
